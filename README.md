...
package_:
  ...
  * Version 1.12.0 and later contain no library code of their own. They vend the same three
    products as before—`IssueReporting`, `IssueReportingTestSupport`, and
    `XCTestDynamicOverlay`—but each simply re-exports the real implementation from
    [swift-issue-reporting][sir] 2.x.

This means packages that depend on this URL and packages that depend on
[swift-issue-reporting][sir] can now coexist in the same dependency graph, sharing a single copy of
...
[swift-issue-reporting][sir]. Update your dependencies (File&nbsp;&gt;&nbsp;Packages&nbsp;&gt;
Update to Latest Package Versions in Xcode, or `swift package update` on the command line) so that
this package resolves to 1.12.0 or later.

## License

This library is released under the MIT license. See [LICENSE](LICENSE) for details.

[sir]: https://github.com/pointfreeco/swift-issue-reporting
